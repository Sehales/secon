 ...
 * 
 * 
 * Class taken from Help & AdminCmd
...
public class FontWidthCalculator {
    ...
    public static String charWidthIndexIndex = " !\"#$%&'()*+,-./"
            ...
            + "'abcdefghijklmno" + "pqrstuvwxyz{|}~âŒ‚"
            + "Ã‡Ã¼Ã©Ã¢Ã¤Ã Ã¥Ã§ÃªÃ«Ã¨Ã¯Ã®Ã¬Ã„Ã…"
            + "Ã‰Ã¦Ã†Ã´Ã¶Ã²Ã»Ã¹Ã¿Ã–ÃœÃ¸Â£Ã˜Ã—Æ’"
            + "Ã¡Ã­Ã³ÃºÃ±Ã‘ÂªÂºÂ¿Â®Â¬Â½Â¼Â¡Â«Â»";
    ...
    public static LinkedList<String> alignTags(LinkedList<String> input, final boolean minecraftChatFormat) {
     ...
     * @return
     */
    public static String strWordWrapRight(String str, final int width, final int tab, final char tabChar) {
        String ret = "";
        while (str.length() > 0) {
            // find last char of first line
     ...
     * @return
     */
    public static String strWordWrapRight(String str, final int width, final int tab, final char tabChar, final char sepChar) {
        String ret = "";
